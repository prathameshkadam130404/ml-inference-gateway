...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckReadiness = channel.unary_unary(
                '/inference.InferenceService/CheckReadiness',
                request_serializer=inference__pb2.ReadinessRequest.SerializeToString,
                response_deserializer=inference__pb2.ReadinessResponse.FromString,
                _registered_method=True)
...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CheckReadiness': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=inference__pb2.ReadinessRequest.FromString,
                    response_serializer=inference__pb2.ReadinessResponse.SerializeToString,
            ),
    }
...
class InferenceService(object):
    ...
    def CheckReadiness(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/inference.InferenceService/CheckReadiness',
            inference__pb2.ReadinessRequest.SerializeToString,
            inference__pb2.ReadinessResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
